...
import { useWebcamCapture, useWebcamStream, useSelectedCam } from "./camState.jsx";
...
export default function Microphone() {
    ...
    const { canStream } = useWebcamStream();
    const micDisabled = (capturing && !recording) || !canStream;
    ...
    return (
        <button id="speech" className={className} disabled={micDisabled}
            onMouseDown={startRecording} onMouseUp={stopRecording}
            onTouchStart={startRecording} onTouchEnd={stopRecording}
            onMouseLeave={stopRecording} onTouchCancel={stopRecording}
        >
